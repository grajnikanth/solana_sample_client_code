...
const airdrop = (address, amount) => __awaiter(void 0, void 0, void 0, function* () {
    // convert address sting to a publickey on solana
    const toAddress = new web3_js_1.PublicKey(address);
...
(0, exports.airdrop)("6rwUaidSXkZMza4s2yx2wp4gDiHBfKZ2c9LqJXHTw91d", 4);
